...
public class Dodawanie implements Instrukcja, Wyrazenie {

    private final Instrukcja argument1;
    private final Instrukcja argument2;

    public Dodawanie(Instrukcja argument1, Instrukcja argument2) {
    ...
    public String toJson() {
        ...
        sb.append("{\n")
          .append("\"typ\":\"Plus\",\n")
          .append("\"argument1\":").append(argument1.toJson())
          .append(",\n\"argument2\":").append(argument2.toJson())
          .append("\n}");
